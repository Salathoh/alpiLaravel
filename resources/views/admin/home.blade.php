...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        <nav class="navbar navbar-expand-lg navbar-dark  shadow" style="background-color: #0174BE;">
            <div class="container">
                <a class="navbar-brand" style="color:white; font-size:larger;font-weight:bolder;font-family: 'Poppins', sans-serif;"
                 href="{{ route('admin.home') }}">D-IV Keamanan Sistem Informasi</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('berita.berita-admin') }}">Berita</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown active"> <!-- Tambahkan class "dropdown" pada list item ini -->
                            <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown2" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Profile
                            </a>
                            <ul class="dropdown-menu active" aria-labelledby="navbarDropdown2">
                                <li><a class="dropdown-item" href="{{ route('ftr.lulusan') }}">Profile Lulusan KSI</a></li>
                                <li><a class="dropdown-item" href="{{ route('ftr.dosen') }}">Profile Dosen</a></li>
                            </ul>
                        </li>
        ...
        <div class="p-5 mb-4 bg-light rounded-3">    
                <h2 class="display-10 fw-bold" style=" font-weight:bolder;font-family: 'Poppins', sans-serif;">
